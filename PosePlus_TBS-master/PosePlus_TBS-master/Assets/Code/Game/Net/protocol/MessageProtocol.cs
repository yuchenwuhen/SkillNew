...
namespace Pomelo.DotNetClient
{
    public class MessageProtocol
    {
        ...
        private JsonNode_Object encodeProtos = new JsonNode_Object();
        private JsonNode_Object decodeProtos = new JsonNode_Object();
        ...
        public Message decode(byte[] buffer)
        {
            ...
            {
                msg = MyJson.MyJson.Parse(Encoding.UTF8.GetString(body));
            }

            //Construct the message
            return new Message(type, id, route, msg as JsonNode_Object);
        }
